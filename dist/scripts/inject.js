...
(function () {
    ...
    var showMenu = lib_1.debounce(function (_e) {
        ...
        if (text && text.length > 1 && !leftClick) {
            selectionMenu.show(mouseX, mouseY, text, function () {
...
var SelectionMenu = /** @class */function () {
     ...
     */
    SelectionMenu.prototype.show = function (x, y, text, onClose) {
     ...
     * @param text Currently selected text
     */
    SelectionMenu.prototype.fillWithActions = function (text, onClose) {
        var _this = this;
...
var open_url_1 = __webpack_require__(8);
var search_in_google_1 = __webpack_require__(9);
exports.default = [search_in_google_1.SearchInGoogleAction,
// tslint:disable-next-line:object-literal-sort-keys
copy_to_clipboard_1.CopyToClipboardAction, open_url_1.OpenUrlAction];
...
var CopyToClipboardAction = /** @class */function (_super) {
    ...
    Object.defineProperty(CopyToClipboardAction.prototype, "applicable", {
        get: function get() {
            return true;
        },
        enumerable: true,
...
var OpenUrlAction = /** @class */function (_super) {
    ...
    Object.defineProperty(OpenUrlAction.prototype, "applicable", {
        get: function get() {
    ...
    Object.defineProperty(OpenUrlAction.prototype, "uid", {
        get: function get() {
            return "open_url";
        },
        enumerable: true,
    ...
    OpenUrlAction.prototype.bind = function (_a) {
        return false;
    };
    OpenUrlAction.prototype.perform = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                this.sendMessage({
                    kind: "open-tab",
    ...
    OpenUrlAction.pattern = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/;
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(0);
var SearchInGoogleAction = /** @class */function (_super) {
    __extends(SearchInGoogleAction, _super);
    function SearchInGoogleAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(SearchInGoogleAction.prototype, "applicable", {
        get: function get() {
            return true;
        },
        enumerable: true,
    ...
    Object.defineProperty(SearchInGoogleAction.prototype, "uid", {
        get: function get() {
    ...
    SearchInGoogleAction.prototype.bind = function (_a) {
        return false;
    };
    SearchInGoogleAction.prototype.perform = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                this.sendMessage({
                    kind: "open-tab",
    ...
    SearchInGoogleAction.pattern = "http://www.google.com/search?q=%term%";
    return SearchInGoogleAction;
}(types_1.Action);
exports.SearchInGoogleAction = SearchInGoogleAction;
